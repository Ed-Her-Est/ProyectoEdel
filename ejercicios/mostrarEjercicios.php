...
<body>
    ...
    <div class="container mt-5">
        <div class="mb-4">
            ...
            <form action="insertarEjercicios.php" method="POST">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" name="grupoMuscular" placeholder="Grupo Muscular" required value="">
                    </div>
                </div>
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <?php while ($row = mysqli_fetch_array($query)): ?>
                        <tr>
                            <td><?= $row['ejercicio_id'] ?></td>
                            <td><?= ucwords($row['nombre_ejercicio']) ?></td>
                            <td><?= $row['descripcion'] ?></td>
                            <td><?= $row['grupo_muscular'] ?></td>
                            <td>
                                <!-- Enlace para editar -->
                                <a class="btn btn-warning" href="updateEjercicios.php?id=<?= $row['ejercicio_id'] ?>">Editar</a>
                            </td>
                            <td>
                                <!-- Formulario para eliminar -->
                                <a class="btn btn-danger" href="deleteEjercicios.php?id=<?= $row['ejercicio_id'] ?>">Eliminar</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
            </table> 
            <a class="btn btn-success" href="respaldarEjercicios.php">Descargar Datos</a>
